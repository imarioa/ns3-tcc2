...
# Set terminal up
set title "SF - 7" font "Times-Roman-Bold,16"
...
set yrange [0:1]
set ytics font ",10"
set ylabel "Vazao (bps)" font "Times-Roman-Bold,16"
set xlabel "numero de dispositvos" font "times-Roman-Bold,16"
set output './TestResult/throughput_security-SF7.png'
set key left top
#set encoding utf8
...
filename1='./TestResult/test10/traffic-600/result-SF7.dat'
filename2='./TestResult/test20/traffic-600/result-SF7.dat'
filename3='./TestResult/test30/traffic-600/result-SF7.dat'
filename4='./TestResult/test40/traffic-600/result-SF7.dat'
filename5='./TestResult/test50/traffic-600/result-SF7.dat'
...
plot filename1 using 1:2 smooth csplines w l ls 1 t 'Cenario 1', \
     filename2 using 1:2 smooth csplines with lines ls 2 title 'Cenario 2', \
     filename3 using 1:2 smooth csplines with lines ls 3 title 'Cenario 3', \
     filename4 using 1:2 smooth csplines with lines ls 4 title 'Cenario 4', \
     filename5 using 1:2 smooth csplines with lines ls 6 title 'Cenario 5'
