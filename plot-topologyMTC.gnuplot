...
set output './TestResult/topology.png'

set style line 3 lc rgb 'black' pt 9 ps 6 
set style line 4 lc rgb 'black' pt 5 ps 2 
...
#filename='./TestResult/test1/endDevices800.dat'
filename_ed='./TestResult/test1/endDevices800.dat'
filename_gw='./TestResult/test1/GWs1.dat'
filename_atk='./TestResult/test1/atkDevices6.dat'
...
plot filename_ed using ($1/1000):($2/1000):3 with points lw 2 ps 2 pt 6 lc 'black' t 'Nodes', filename_ed using ($1/1000):($2/1000):3 with points ps 1.2 pt 7 palette notitle, filename_gw using 1:2 with points ls 3 t 'Gateway', filename_atk using ($2/1000):($3/1000):4 with points ls 4 t 'Atks'
