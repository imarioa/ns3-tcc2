...
set output './TestResult/throughput_security.png'
set key left top
#set encoding utf8
...
filename1='./TestResult/test1/traffic-600/result-STAs.dat'
filename2='./TestResult/test2/traffic-600/result-STAs'
filename3='./TestResult/test3/traffic-600/result-STAs'
filename4='./TestResult/test4/traffic-600/result-STAs'
filename5='./TestResult/test5/traffic-600/result-STAs'
